...
public class SevenWaySplitModified implements RuleExtractorInterface{
...
//            findLargestCommonSubstring(sRoot, sMorphed.substring(0,sMorphed.length()),0);
    ...
    public String getExtractorName(){
        return "Seven Way Split Modified with reduction and expansion empty vowels";
    }
}
