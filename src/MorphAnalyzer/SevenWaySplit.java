 ...
 * SevenWaySplit.java
 *
 * Created on May 14, 2005, 12:20 PM
 */
...
public class SevenWaySplit implements RuleExtractorInterface{
...
/*        String sMorphedPOS = sMorphed.substring(morphedPOSIndex,morphedPOSIndex + morphedPOSLength);
    ...
    private int findLargestCommonSubstring(String sMorphed, String sRoot, int nRootOffset) {
...
/*                    k--;
                    ...
                    k--;
                    // Added so as not to consider reduction or expansion from an empty string
                    if (tempRootVowelLength == 0 || tempMorphedVowelLength == 0) {
                        k = tempRootVowelIndex;
                        j = tempMorphedVowelIndex;
                        tempLength--;
                        tempMorphedVowelLength = 0;
                        tempRootVowelLength = 0;
                        tempRootVowelIndex = 0;
                        tempMorphedVowelIndex = 0;
                        hasVowelChange = false;
